...
const App = () => {
  ...
  const handlepost = async () => {
    ...
    setIsClick(true);
    try {
      const res = await axios.post('https://contentcrafter-python-blog-1.onrender.com/blogPost', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
          ...
          <div className="form-container">
            <form onSubmit={handleSubmit}>
              <label>
                ...
                <div style={{ color: 'black', marginTop: '15px' }}>with the</div>
                <Tooltip
                  componentsProps={{
                    tooltip: {
                      sx: {
         ...
         <FontAwesomeIcon icon={faBlogger} size="2xl" style={{ color: "#f5c000"}} />
            ...
            {response && (
              ...
              >
                ...
                <Button
                  ...
                  onClick={handleDownloadDocx} style={{ height: '42px' }}
                >
                  <DownloadIcon />
                </Button>
              </Tooltip>
            ...
            {response && (
              <Tooltip
                ...
                arrow
              >
                <Button className="copy-button" onClick={handleCopyToClipboard} style={{ height: '35px' }}>
